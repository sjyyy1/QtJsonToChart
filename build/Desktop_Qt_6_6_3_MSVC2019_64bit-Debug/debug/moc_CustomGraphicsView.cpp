...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSCustomGraphicsViewENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSCustomGraphicsViewENDCLASS_t qt_meta_stringdata_CLASSCustomGraphicsViewENDCLASS = {
    {
        QT_MOC_LITERAL(0, 18),  // "CustomGraphicsView"
        QT_MOC_LITERAL(19, 12),  // "scaleChanged"
        QT_MOC_LITERAL(32, 0),  // ""
        QT_MOC_LITERAL(33, 15),  // "scalePercentage"
        QT_MOC_LITERAL(49, 8)   // "setScale"
    },
    "CustomGraphicsView",
    "scaleChanged",
    "",
...
void CustomGraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &CustomGraphicsView::scaleChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CustomGraphicsView::scaleChanged(int _t1)
{
